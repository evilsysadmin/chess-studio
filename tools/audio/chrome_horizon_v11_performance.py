...
P={
 "Em":[(0,64,.78,88,"sus"),(1.15,67,.52,84,"hammer"),(2.05,71,1.48,104,"sus")],
 "C":[(0,64,.70,87,"sus"),(1.08,67,.52,84,"slide_in"),(2.02,72,1.50,105,"sus")],
 "Bm":[(0,66,.56,82,"mute"),(1.05,69,.54,86,"hammer"),(2.02,74,1.44,106,"sus")],
 "Am":[(0,69,.68,88,"sus"),(1.08,72,.50,85,"hammer"),(2.02,67,.90,97,"pull"),(3.22,64,.46,79,"mute")],
}
DEV={
 "Em":[(0,64,.52,82,"mute"),(.86,67,.38,83,"hammer"),(1.38,71,.70,94,"sus"),(2.42,74,.38,91,"slide_up"),(3.02,71,.64,104,"sus")],
 "C":[(0,64,.56,87,"sus"),(.86,67,.38,83,"hammer"),(1.38,72,.72,96,"sus"),(2.40,71,.34,86,"pull"),(3.00,67,.66,103,"sus")],
 "Bm":[(0,66,.50,81,"mute"),(.84,69,.38,84,"hammer"),(1.36,74,.72,97,"sus"),(2.38,72,.34,86,"pull"),(3.00,71,.66,104,"sus")],
 "Am":[(0,69,.54,88,"sus"),(.86,72,.36,84,"hammer"),(1.38,76,.72,108,"sus"),(2.48,72,.32,86,"pull"),(3.00,67,.64,95,"sus")],
}
LIFT={
 "Em":[(0,64,.48,81,"mute"),(.72,67,.32,84,"hammer"),(1.18,71,.52,91,"slide_up"),(2.02,76,1.28,111,"sus")],
 "C":[(0,67,.50,89,"sus"),(.72,71,.32,85,"hammer"),(1.18,72,.52,92,"slide_up"),(2.02,76,1.28,112,"sus")],
 "Bm":[(0,66,.48,81,"mute"),(.72,69,.32,85,"hammer"),(1.18,74,.54,94,"slide_up"),(2.02,79,1.25,114,"sus")],
 "Am":[(0,69,.50,89,"sus"),(.72,72,.32,86,"hammer"),(1.18,76,.62,110,"sus"),(2.25,74,.32,87,"pull"),(2.80,71,.76,98,"sus")],
}
CLIMAX={
 "Em":[(0,64,.44,82,"mute"),(.60,67,.28,86,"hammer"),(1.00,71,.48,96,"slide_up"),(1.66,76,1.08,118,"sus"),(3.12,74,.28,89,"pull")],
 "C":[(0,67,.44,91,"sus"),(.60,71,.28,87,"hammer"),(1.00,72,.48,97,"slide_up"),(1.66,76,1.08,119,"sus"),(3.12,74,.28,89,"pull")],
 "Bm":[(0,66,.42,82,"mute"),(.58,69,.28,87,"hammer"),(.98,74,.48,99,"slide_up"),(1.64,79,1.04,122,"sus"),(3.08,76,.28,91,"pull")],
