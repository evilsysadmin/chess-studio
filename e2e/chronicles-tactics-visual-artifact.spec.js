...
for (const capture of CAPTURES) {
  test(`Chronicles Tactics · visual proof · ${capture.label}`, async ({ browser }) => {
    ...
    try {
      ...
      // Forecast visual proof: from the canonical opening, stepping east enters
      // the corrupted pawn's response range. The compact badge/border must be
      // visible and its full warning must remain available to assistive tech.
