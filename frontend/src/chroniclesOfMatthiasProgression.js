...
export const CHRONICLES_SKILL_DEFINITIONS = Object.freeze({
  matthias: Object.freeze([
    ...
    Object.freeze({
      id: 'matthias-executioner-oath',
      label: 'Juramento del verdugo',
      description: 'Ruptura del verdugo gana +3 potencia.',
      requiredLevel: 6,
      cost: 1,
      group: 'doctrine-3',
      modifiers: Object.freeze({ abilityPotencyBonus: 3 }),
      profileOverrides: Object.freeze({
        abilityName: 'Ruptura del verdugo',
        abilityLabel: 'golpe de ejecución mayor',
      }),
    }),
    Object.freeze({
      id: 'matthias-twin-rupture',
      label: 'Ruptura gemela',
      description: '+1 uso de Ruptura por incursión.',
      requiredLevel: 6,
      cost: 1,
      group: 'doctrine-3',
      modifiers: Object.freeze({ abilityCharges: 1 }),
      profileOverrides: Object.freeze({
        abilityName: 'Ruptura gemela',
        abilityLabel: 'doble maniobra',
      }),
    }),
  ]),
  rook: Object.freeze([
    ...
    Object.freeze({
      id: 'rook-wallbreaker',
      label: 'Quebramuros',
      description: 'Martillo Quebramuros gana +3 potencia.',
      requiredLevel: 6,
      cost: 1,
      group: 'doctrine-3',
      modifiers: Object.freeze({ abilityPotencyBonus: 3 }),
      profileOverrides: Object.freeze({
        abilityName: 'Martillo Quebramuros',
        abilityLabel: 'impacto de demolición',
      }),
    }),
    Object.freeze({
      id: 'rook-reserve-hammer',
      label: 'Martillo de reserva',
      description: '+1 uso de Martillo por incursión.',
      requiredLevel: 6,
      cost: 1,
      group: 'doctrine-3',
      modifiers: Object.freeze({ abilityCharges: 1 }),
      profileOverrides: Object.freeze({
        abilityName: 'Martillo de reserva',
        abilityLabel: 'doble impacto pesado',
      }),
    }),
  ]),
  ...
  knight: Object.freeze([
    ...
    Object.freeze({
      id: 'knight-grand-volley',
      label: 'Gran salva',
      description: 'La salva puede alcanzar hasta 3 objetivos y gana +1 potencia.',
      requiredLevel: 6,
      cost: 1,
      group: 'doctrine-3',
      modifiers: Object.freeze({ abilityPotencyBonus: 1 }),
      profileOverrides: Object.freeze({
        ...
        abilityLabel: 'salva de saturación',
        abilityMaxTargets: 3,
      }),
    }),
    Object.freeze({
      id: 'knight-field-quiver',
      label: 'Carcaj de campaña',
      description: '+1 uso de Salva por incursión.',
      requiredLevel: 6,
      cost: 1,
      group: 'doctrine-3',
      modifiers: Object.freeze({ abilityCharges: 1 }),
      profileOverrides: Object.freeze({
        abilityName: 'Carcaj de campaña',
        abilityLabel: 'salva de reserva',
      }),
    }),
  ]),
});
