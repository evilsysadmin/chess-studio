...
describe('MatthiasHomeVisit · residente de Home', () => {
  it('cuando está callado usa el arte canónico original y no pinta bocadillo', () => {
  ...
  it('cuando tiene algo real que decir conserva el arte original y muestra un único bocadillo', () => {
