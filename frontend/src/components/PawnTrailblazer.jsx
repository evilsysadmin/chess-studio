    ...
    <div className="pawn-trailblazer" data-pawn-trailblazer="true">
      <div className="pawn-trailblazer-head">
        <div>
          ...
          <p>Matthias avanza solo. Peones forcejean, caballos saltan y las torres te pasan por encima si las recibes de frente. Captura en diagonal para encadenar combo.</p>
        </div>
      ...
      <div className="pawn-trailblazer-shell">
        ...
        <div className="pawn-trailblazer-controls">
          ...
          <div><kbd>ESPACIO</kbd><span>Forcejea contra peones.</span></div>
        ...
        <p className="pawn-trailblazer-note">Motor {rendererName}. Three.js controla cámara, escena, sprites y render; la lógica arcade sigue separada de React y del rating competitivo.</p>
      </div>
    </div>
  );
}
