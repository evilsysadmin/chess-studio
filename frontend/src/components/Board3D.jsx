...
export default function Board3D(props) {
  ...
  // here used to mark a game as "seen" as soon as Hans entered the viewport,
  // which could kill the React narrative after an F5/remount halfway through
  // the fireplace number. Completion is now persisted by GameBoardView only
  // after WarRoomHansFireCall reaches its real terminal state.
  useLayoutEffect(() => {
