...
export function matthiasWarRoomStateDescriptor(mode, angerLevel = 0) {
  ...
  const descriptors = {
    ...
    [MATTHIAS_WAR_ROOM_STATES.GLANCE]: { expression: 'alert', activity: 'Vigilando el tablero', gesture: 'glance' },
    [MATTHIAS_WAR_ROOM_STATES.GLARE]: { expression: 'glare', activity: 'Vigilancia hostil', gesture: 'glare' },
    [MATTHIAS_WAR_ROOM_STATES.HEAD_LEFT]: { expression: 'stern', activity: 'Inspeccionando el flanco', gesture: 'head-left' },
    [MATTHIAS_WAR_ROOM_STATES.HEAD_RIGHT]: { expression: 'stern', activity: 'Inspeccionando el flanco', gesture: 'head-right' },
