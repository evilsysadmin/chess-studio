...
describe('WarRoom3DMotion', () => {
  ...
  it('keeps coarse-pointer lighting readable without adopting the brighter desktop exposure', () => {
    ...
    expect(mobile.key).toBeLessThanOrEqual(2.12);
