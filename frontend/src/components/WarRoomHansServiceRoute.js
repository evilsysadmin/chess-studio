...
export function moveWarRoomHansToward(hans, target, maxStep) {
  ...
  // Navigation owns the horizontal route only. Rendered shoe/surface grounding
  // is the single authority for Y; rewriting it here can visibly lift Hans
  // before the later invisible-driver grounding pass gets a chance to run.
