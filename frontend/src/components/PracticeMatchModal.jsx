  ...
  return (
    <div className="modal-backdrop" onClick={onClose}>
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label="Configurar partida de práctica"
      ...
      >
        ...
        <p className="hint-text friendly-lead">
          Pistas gratuitas, cero premio y cero penalización ELO. Aquí vienes a probar cosas sin que Matthias cobre peaje estadístico.
        </p>
        ...
        >
          ...
          <span>
            <b>Adaptativo suave</b>
            <small>
              Parte de tu nivel y baja un pequeño escalón para favorecer práctica útil · nivel {adaptiveLevel} · {difficultyLabel(adaptiveLevel)}
            </small>
          </span>
        ...
        {autoDifficulty && (
          <button type="button" className="text-action adaptive-manual-link" onClick={() => setAutoDifficulty(false)}>
