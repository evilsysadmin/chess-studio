export const WAR_ROOM_CANONICAL_PLANT_PLACEMENT_VERSION = 'war-room-plant-window-corner-v3';
...
export function lockWarRoomCanonicalPlantPlacement(root) {
  ...
  plant.position.x = x;
  plant.position.z = z;
  plant.userData.warRoomPlantPlacement = 'canonical-weather-window-corner-v17';
  plant.userData.warRoomPlantOcclusionFix = 'stable-wall-corner-board-clearance-v17';
