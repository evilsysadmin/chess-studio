...
export function buildCombatBriefingDossier({ campaign, node, intel, armySummary } = {}) {
  ...
  return {
    ...
    facts: {
      ...
      boss_label: cleanText(intel.bossLabel, 80),
      boss_mechanic: cleanText(intel.bossMechanic, 80),
      boss_mechanic_description: cleanText(intel.bossMechanicDescription, 180),
