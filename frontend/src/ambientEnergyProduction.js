const ENERGY_PROFILES = Object.freeze({
  ...
  neonSiege: Object.freeze({
    leadInstrument:'overdriveGuitar', counterInstrument:'anthemLead', chordInstrument:'powerPad', bassInstrument:'synthbass',
    chordHoldSteps:6, bassHoldSteps:1.35,
    mix:Object.freeze({lead:0.78,counter:0.54,bass:1.20,chord:0.42}),
  ...
  overclockedKnight: Object.freeze({
    leadInstrument:'anthemLead', counterInstrument:'overdriveGuitar', chordInstrument:'widePad', bassInstrument:'synthbass',
    chordHoldSteps:7, bassHoldSteps:1.45,
    mix:Object.freeze({lead:0.70,counter:0.66,bass:1.18,chord:0.38}),
  ...
  reactorGambit: Object.freeze({
    leadInstrument:'overdriveGuitar', counterInstrument:'neonBrass', chordInstrument:'powerPad', bassInstrument:'synthbass',
    chordHoldSteps:8, bassHoldSteps:1.7,
    mix:Object.freeze({lead:0.76,counter:0.48,bass:1.18,chord:0.44}),
