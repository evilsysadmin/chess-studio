...
export function pawnSlugPistolFirePhase(recoilRemaining = 0) {
  ...
  if (progress < PAWN_SLUG_PISTOL_FEEL.raisePortion) return Object.freeze({ active: true, phase: 'raise', progress: progress / PAWN_SLUG_PISTOL_FEEL.raisePortion });
  if (progress < PAWN_SLUG_PISTOL_FEEL.raisePortion + PAWN_SLUG_PISTOL_FEEL.blastPortion) return Object.freeze({ active: true, phase: 'blast', progress: (progress - PAWN_SLUG_PISTOL_FEEL.raisePortion) / PAWN_SLUG_PISTOL_FEEL.blastPortion });
