...
export const CHESSCOM_WEAPON_ART_V11 = Object.freeze({identity:'weapon-art-v11',weapons:Object.freeze(['hk416','g36c','mp5sd'])});
...
export function installChesscomWeaponArtV11(host){
  ...
  const sync=()=>{const key=chesscomWeaponArtKey(label.textContent||'');if(key) art.dataset.weapon=key;else delete art.dataset.weapon;};
  sync();
  ...
  return {destroy(){observer?.disconnect();delete art.dataset.weapon;}};
}
