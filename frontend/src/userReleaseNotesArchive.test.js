...
import { USER_RELEASE_NOTES, currentUserReleaseNotes } from './userReleaseNotesArchive.js';

describe('archivo de novedades para jugadores', () => {
  it('conserva el archivo histórico, con contenido útil y sin jerga interna', () => {
