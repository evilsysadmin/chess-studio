...
// ARCHIVO. Changelog histórico (hasta la release v16.6dm46zfrv). Las novedades vigentes viven
// en userReleaseNotesData.js; este fichero sólo se carga si el jugador abre «Ver anteriores».
