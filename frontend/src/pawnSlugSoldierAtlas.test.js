...
describe('Pawn Slug Blender soldier atlas', () => {
  it('uses the reviewed Blender bake from R2 without carrying a duplicate local WebP', () => {
    ...
    expect(PAWN_SLUG_SOLDIER_ATLAS_META).not.toHaveProperty('localFallbackAsset');
