...
describe('dm46w · product polish contracts', () => {
  it('Novedades publica sólo cambios comprensibles y útiles para jugadores', () => {
    ...
    expect(payload).not.toMatch(/\bE2E\b|Playwright|Grafana|Tempo|Terraform|telemetr[ií]a|pipeline|CI\/CD|quality gate/i);
    const current = currentUserReleaseNotes('v16.6dm46w');
