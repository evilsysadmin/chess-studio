...
function AppInner({ isAdminUser }) {
  ...
  const { pvp, pvpMatch, openPvpMatch, acceptIncomingPvpChallenge, exitPvpMatch } = usePvpAppFlow({
    view,
    replaceView,
    setCombatBattleUiActive,
  });
  ...
  return (
    <>
      ...
      <PvpChallengeSurface view={view} pvp={pvp} onAccept={acceptIncomingPvpChallenge} />
      <ErrorBoundary
        view={view}
      ...
      <div className={`app-shell ${isBoardGameView ? 'app-shell-board-game' : ''} ${view === 'menu' ? 'app-shell-home' : ''}`} id="main-content" tabIndex={-1}>
        ...
        <PvpGameSurface view={view} match={pvpMatch} onExit={exitPvpMatch} />
