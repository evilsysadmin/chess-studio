...
const STRICT_RUNTIME_GENERATION := "v18"
const FULL_ATLAS_URLS := {
    "pistol": "https://assets.chess-studio.shadowops.dpdns.org/pawn-slug-godot/matthias/strict-v18/pistol/v18-85849b4873c0f88e.png",
