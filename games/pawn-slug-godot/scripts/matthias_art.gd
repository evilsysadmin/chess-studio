...
const FULL_ATLAS_URLS := {
    ...
    "machinegun": "https://assets.chess-studio.shadowops.dpdns.org/pawn-slug-godot/matthias/hurt-alpha-v2/machinegun/full/machinegun-hurt-alpha-v2-55e21e6e1cb45528.png",
