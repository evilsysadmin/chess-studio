...
const STRICT_RUNTIME_GENERATION := "v19"
const FULL_ATLAS_URLS := {
    "pistol": "https://assets.chess-studio.shadowops.dpdns.org/pawn-slug-godot/matthias/strict-v19/pistol/v19-0b8781557495b922.png",
