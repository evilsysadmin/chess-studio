...
const STRICT_RUNTIME_GENERATION := "v20"
const FULL_ATLAS_URLS := {
    "pistol": "https://assets.chess-studio.shadowops.dpdns.org/pawn-slug-godot/matthias/strict-v20/pistol/v20-2b12fd13f4f73f74.png",
