...
const maxGlobalModules = 26;
const expectedOwner = '28-product-resilience.css';
const failures = [];
if (globalModules.length > maxGlobalModules) failures.push(`global CSS modules ${globalModules.length} > debt budget ${maxGlobalModules}`);
...
console.log(`css-debt-budget OK · ${globalModules.length}/${maxGlobalModules} global modules · ${modules.length - globalModules.length} lazy · one final product-resilience owner`);
