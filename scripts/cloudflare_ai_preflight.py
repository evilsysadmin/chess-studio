...
def static_check() -> list[str]:
    ...
    for needle, label in (
        ...
        ("# Production service lanes: backend and Worker start in parallel from the immutable gate.", "backend and Worker promotion lanes are parallel"),
        ("Production · frontend build", "promotion frontend build lane"),
        ...
        ("needs: [gate, cloudflare, backend, pages_build]", "Pages waits for parallel service lanes plus frontend build"),
