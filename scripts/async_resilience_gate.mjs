...
requirePattern('frontend/src/standardChessCpuMatch.js', /abortableDelay\(/, 'el loop espectador debe usar esperas cancelables');
requirePattern('frontend/src/standardChessCpuMatch.js', /analyzePosition\([^\n]+\{\s*signal\s*\}/, 'análisis espectador debe cancelarse');
