...
assert(worker.includes("const CACHE = 'chess-studio-shell-v2'"), 'la caché PWA sigue acoplada a una release antigua');

console.log('pwa-check OK · manifest + worker versionado por build + shell offline + API network-only');
