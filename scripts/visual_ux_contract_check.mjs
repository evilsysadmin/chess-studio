...
const contractImport = "@import './styles/28-viewport-action-coherence.css';";
...
console.log('visual-ux-contract OK · viewport desktop normal/portátil + Combat + coherencia de acciones protegidos');
