...
def main():
 ...
 for w in ['pistol','machinegun','shotgun','panzerfaust']:
  im=Image.open(a.run_dir/w/'v22.png').convert('RGBA'); sc=.5; fw=int(CELL*sc); fh=int(CELL*sc); b=Image.new('RGBA',(fw*6,fh*2+28),(14,16,19,255)); dd=ImageDraw.Draw(b); dd.text((6,5),f'{w} RUN12',fill='white')
