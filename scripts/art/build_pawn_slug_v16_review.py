...
def main():
    ...
    draw.text((LABEL, 2), "v15 baseline", fill=(170, 170, 170, 255))
    draw.text((LABEL + PAIR, 2), "v16 candidate", fill=(170, 170, 170, 255))
    for row in range(ROWS):
        ...
        for side, image in enumerate((old, new)):
            for index, col in enumerate(PICKS):
                ...
                board.alpha_composite(crop, (LABEL + side * PAIR + index * TH, y + 20))
