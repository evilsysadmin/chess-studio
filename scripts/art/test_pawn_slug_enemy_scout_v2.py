...
from derive_pawn_slug_enemy_scout_v2 import CELL, FRAMES, build
...
class ScoutV2Tests(unittest.TestCase):
    def test_scout_adds_sensor_profile_without_moving_feet(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            for i in range(FRAMES):
                ...
                self.assertLess(after[1], before[1], "sensor mast should raise profile")
