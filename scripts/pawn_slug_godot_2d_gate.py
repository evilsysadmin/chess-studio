...
REQUIRED_MATTHIAS = (
    ...
    "RUN13_ATLAS_COLUMNS := 13",
    "MACHINEGUN_RUN13_URL",
    "RUN13_ATLAS_SIZE := Vector2i(",
    "_run_overlay_layout",
    "_run_overlay_url",
    '"run13-v23"',
...
def self_test() -> None:
    ...
    assert "RUN13_ATLAS_COLUMNS := 13" in REQUIRED_MATTHIAS
    assert "MACHINEGUN_RUN13_URL" in REQUIRED_MATTHIAS
    assert '"run13-v23"' in REQUIRED_MATTHIAS
