...
REQUIRED_MATTHIAS = (
    ...
    '"locomotion-v10"',
    'STRICT_RUNTIME_GENERATION := "v15"',
    "V9_ATLAS_COLUMNS := 8",
    "V9_ATLAS_ROWS := 18",
    "V9_ATLAS_CELL_SIZE := 416",
    "V9_ATLAS_SIZE := Vector2i(",
    "/pawn-slug-godot/matthias/strict-v15/pistol/v15-c864afdb9bb6f8bb.png",
    "/pawn-slug-godot/matthias/strict-v15/machinegun/v15-32227acfdc2e0cff.png",
    "/pawn-slug-godot/matthias/strict-v15/shotgun/v15-1dcb9bee090747c4.png",
    "/pawn-slug-godot/matthias/strict-v15/panzerfaust/v15-ed8aed181601acb0.png",
    "V9_BODY_SCALE := 0.43",
