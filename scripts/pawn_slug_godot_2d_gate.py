...
REQUIRED_MATTHIAS = (
    ...
    '"locomotion-v10"',
    'STRICT_RUNTIME_GENERATION := "canonical-continuity-v6"',
    ...
    "/pawn-slug-godot/matthias/pose-semantics-v1/pistol/full/",
    "/pawn-slug-godot/matthias/pose-semantics-v1/machinegun/full/",
    "/pawn-slug-godot/matthias/pose-semantics-v1/shotgun/full/",
    "/pawn-slug-godot/matthias/pose-semantics-v1/panzerfaust/full/",
    "/pawn-slug-godot/matthias/run12-v22/pistol/v22-07d2a11a2249989b.png",
    "/pawn-slug-godot/matthias/continuity-repair/machinegun/run13/machinegun-run13-repaired-f37fd16c29eb44db.png",
    "/pawn-slug-godot/matthias/canonical-scale/shotgun/run12/candidate-run12-e90510cd4fba3827.png",
    "/pawn-slug-godot/matthias/canonical-scale/panzerfaust/run12/candidate-run12-6ea25f1bdac27f35.png",
    ...
    "V9_ACTIONS",
    '"shoot": {"row": 8, "fps": 20.0',
    '"reload": {"row": 15, "fps": 13.333333',
    '"die": {"row": 17, "fps": 12.0',
    '"crouch_walk": {"row": 7',
    '"shoot_up": {"row": 9',
    '"shoot_down": {"row": 10',
    ...
    "_sync_locomotion_playback",
    "_locomotion_phase",
    "_restore_locomotion_phase",
...
FORBIDDEN_MATTHIAS = (
    ...
    "RUNTIME_PRELOAD_ORDER",
    "_prefetch_runtime_atlases",
...
REQUIRED_ENEMIES = (
    ...
    "/pawn-slug/enemies/cast-v2/",
    "BODY_ATLAS_V2_URL",
    "REMOTE_ATLAS_ROWS := 8",
    "LEGACY_REMOTE_ATLAS_ROWS := 3",
    "LEGACY_REMOTE_TYPE_ROW",
    "load_webp_from_buffer",
    "ENEMY_VISUAL_SCALE",
    "_uses_integrated_body_weapon",
    "INTEGRATED_MUZZLE_SOURCE_PX",
    "_integrated_muzzle_position",
    "_weapon_root.position = Vector2.ZERO",
    "_weapon_sprite.visible = false",
    "and not _uses_integrated_body_weapon()",
    "_body_texture_failed",
    "_install_fallback_body_texture",
    "fallback art is reserved for a confirmed failure",
    '"scout"',
    '"commando"',
    '"shield"',
)
...
def self_test() -> None:
    ...
    assert "_sync_locomotion_playback" in REQUIRED_MATTHIAS
