...
REQUIRED_MATTHIAS = (
    ...
    '"locomotion-v10"',
    'STRICT_RUNTIME_GENERATION := "v19"',
    "V9_ATLAS_COLUMNS := 8",
    "V9_ATLAS_ROWS := 18",
    "V9_ATLAS_CELL_SIZE := 416",
    "V9_ATLAS_SIZE := Vector2i(",
    "/pawn-slug-godot/matthias/strict-v19/pistol/v19-0b8781557495b922.png",
    "/pawn-slug-godot/matthias/strict-v17/machinegun/v17-63e2021dd301fa44.png",
...
REQUIRED_PLAYER_MOBILITY = (
    ...
    "_update_ledge_climb",
    "LADDER_CLIMB_SPEED",
    "_find_ladder_candidate",
    "_can_enter_ladder",
    "_start_ladder_climb",
    "_update_ladder_climb",
    "_trigger_fall_death",
...
REQUIRED_RUNTIME_PROBE = (
    ...
    "is_climbing_probe",
    "configure_traversal_probe",
    "find_ladder_candidate_probe",
    "can_enter_ladder_probe",
    "start_ladder_climb_probe",
    "update_ladder_climb_probe",
    "is_ladder_climbing_probe",
    "trigger_fall_death_probe",
    "quantize_aim_probe",
)
REQUIRED_RUNTIME_SMOKE = (
    ...
    "ladder activa estado de subida real",
    "DOWN al pie de escalera conserva crouch",
    "pozo consume exactamente una vida",
