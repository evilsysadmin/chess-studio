...
REQUIRED_MATTHIAS = (
    ...
    '"locomotion-v10"',
    'STRICT_RUNTIME_GENERATION := "v13"',
    "V9_ATLAS_COLUMNS := 8",
    "V9_ATLAS_ROWS := 18",
    "V9_ATLAS_CELL_SIZE := 416",
    "V9_ATLAS_SIZE := Vector2i(",
    "/pawn-slug-godot/matthias/strict-v13/pistol/v13-5c28bf8632a67c82.png",
    "/pawn-slug-godot/matthias/strict-v13/machinegun/v13-66f55797e9447a8d.png",
    "/pawn-slug-godot/matthias/strict-v13/shotgun/v13-52731c02ef5fe0f1.png",
    "/pawn-slug-godot/matthias/strict-v13/panzerfaust/v13-0d4d195a1f0b8ad2.png",
    "V9_BODY_SCALE := 0.43",
