...
REQUIRED_MATTHIAS = (
    ...
    '"locomotion-v10"',
    'STRICT_RUNTIME_GENERATION := "v14"',
    "V9_ATLAS_COLUMNS := 8",
    "V9_ATLAS_ROWS := 18",
    "V9_ATLAS_CELL_SIZE := 416",
    "V9_ATLAS_SIZE := Vector2i(",
    "/pawn-slug-godot/matthias/strict-v14/pistol/v14-9ded4a9961a96cf6.png",
    "/pawn-slug-godot/matthias/strict-v14/machinegun/v14-93d9f9d9f1895711.png",
    "/pawn-slug-godot/matthias/strict-v14/shotgun/v14-9bc62beb46a5be92.png",
    "/pawn-slug-godot/matthias/strict-v14/panzerfaust/v14-2177056edc0cb845.png",
    "V9_BODY_SCALE := 0.43",
...
REQUIRED_ENEMIES = (
    ...
    "Healthy remote request still pending",
