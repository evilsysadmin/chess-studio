...
def build_character():
    ...
    leather=mat('classic black leather',(.008,.006,.005),.30,.18); brass=mat('classic aged brass',(.50,.27,.055),.20,.93); cap_red=mat('classic cap oxblood band',(.075,.012,.009),.38,.06); black=mat('classic brow eye mouth',(.0015,.002,.003),.48); paper=mat('paper',(.67,.58,.43),.88)
    rig=build_rig(); rig['matthias_asset_version']='home-blender-classic-v13'; rig['canonical_identity']='stern-no-moustache-pawn'; rig['canonical_reference']='classic-pawn-first-avatar'; rig['canonical_reference_sha256']='beb64c1dffd6b32a64847b8f768df43e823e858acf630516e27a2cc771e2d975'; rig['canonical_pose_language']='permanently-stern'
    root=[]; spine=[]; head=[]
    ...
    cap_crown=loft_ellipse('Classic cap crown',[(.352,.274,1.535,0.000),(.365,.280,1.580,.006),(.385,.290,1.625,.020),(.405,.300,1.670,.040),(.420,.308,1.710,.064),(.415,.305,1.748,.082)],navy,120,.008)
    cap_top=elliptic_cyl('Classic cap top',(0,.095,1.770),.470,.034,.72,navy,(math.radians(-4),0,0),124,.015)
    visor=crescent_visor('Classic cap visor',(0,-.010,1.505),leather,.280,.430,.170,.220,.026,13,46)
    cap_badge=front_ellipse('Classic cap badge',(0,-.322,1.635),.047,.055,.010,brass,40,.003); cap_badge_inset=front_ellipse('Classic cap badge inset',(0,-.329,1.635),.026,.031,.008,leather,36,.002)
    head += [
        sphere('Head',(0,-.012,1.345),(.350,.330,.340),ivory,96),
        front_ellipse('Eye.L',(-.112,-.345,1.382),.022,.037,.009,black,40,.002), front_ellipse('Eye.R',(.112,-.345,1.382),.022,.037,.009,black,40,.002),
        box('Brow.L',(-.112,-.356,1.455),(.096,.008,.021),black,(0,math.radians(31),0),.004), box('Brow.R',(.112,-.356,1.455),(.096,.008,.021),black,(0,math.radians(-31),0),.004),
        ...
        cap_crown,cap_top, elliptic_cyl('Classic cap band',(0,-.004,1.535),.360,.082,.84,cap_red,(math.radians(-2),0,0),116,.010), elliptic_cyl('Classic cap brass line',(0,-.010,1.493),.356,.013,.84,brass,(math.radians(-2),0,0),116,.003), visor, cap_badge,cap_badge_inset,
        box('Classic cap badge wing.L',(-.078,-.321,1.642),(.052,.006,.014),brass,(0,math.radians(-12),math.radians(12)),.003), box('Classic cap badge wing.R',(.078,-.321,1.642),(.052,.006,.014),brass,(0,math.radians(12),math.radians(-12)),.003),
    ]
