...
HEAD_TO_BASE_WIDTH = (0.62, 0.68)
HEAD_TO_BODY_HEIGHT = (0.42, 0.47)
CAP_TO_HEAD_WIDTH = (1.07, 1.14)
BODY_HEIGHT_TO_BASE_WIDTH = (1.40, 1.60)

# Broad, tilted, curved officer cap; never a flat beret or cylindrical kepi.
CAP_TOP_TO_CROWN_WIDTH = (1.00, 1.06)
CAP_TOP_MIN_REAR_OFFSET = 0.015
CAP_TOP_MIN_VERTICAL_SEPARATION = 0.020
CAP_TOP_LATERAL_OFFSET = (-0.060, -0.010)
CAP_VISOR_TO_HEAD_WIDTH = (0.72, 0.82)
CAP_VISOR_BROW_CLEARANCE = (0.020, 0.095)
