...
CAP_TOP_MIN_VERTICAL_SEPARATION = 0.055
CAP_TOP_LATERAL_OFFSET = (-0.100, -0.025)
...
IVORY_HEAD_RED = (0.54, 0.62)
IVORY_HEAD_GREEN = (0.42, 0.50)
IVORY_HEAD_BLUE = (0.26, 0.34)
