...
def build_scene(reference: Path, samples: int, max_width: int, engine: str):
    ...
    materials = {
        "stone": material("HOME_MAT_stone", (0.045, 0.052, 0.060, 1), roughness=0.97, bump_scale=5.8, bump_strength=0.31, variation=0.26, variation_scale=3.8),
        "arch_stone": material("HOME_MAT_arch_stone", (0.062, 0.069, 0.078, 1), roughness=0.96, bump_scale=5.4, bump_strength=0.29, variation=0.24, variation_scale=4.0),
        "stair_stone": material("HOME_MAT_stair_stone", (0.060, 0.066, 0.074, 1), roughness=0.96, bump_scale=5.2, bump_strength=0.25, variation=0.20, variation_scale=4.2),
        ...
        "wood": material("HOME_MAT_wood", (0.038, 0.012, 0.006, 1), roughness=0.74, bump_scale=5.0, bump_strength=0.13, variation=0.29, variation_scale=2.2, grain=True),
