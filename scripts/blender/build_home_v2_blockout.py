...
def build_scene(reference: Path, samples: int, max_width: int, engine: str):
    ...
    materials = {
        ...
        "armor_steel": material("HOME_MAT_armor_steel", (0.22, 0.24, 0.26, 1), roughness=0.36, metallic=0.82),
        ...
        "globe": material("HOME_MAT_globe", (0.22, 0.12, 0.05, 1), roughness=0.58, variation=0.22, variation_scale=3.4),
