...
def build_scene(reference: Path, samples: int, max_width: int, engine: str):
    ...
    materials = {
        ...
        "gilt_plain": material("HOME_MAT_gilt_plain", (0.80, 0.52, 0.13, 1), roughness=0.38, emission=(0.55, 0.32, 0.06, 1), emission_strength=0.10),
        "gilt_light": material("HOME_MAT_gilt_light", (0.98, 0.76, 0.30, 1), roughness=0.30, emission=(0.80, 0.55, 0.14, 1), emission_strength=0.18),
    ...
    # Two banners, one per side of the central arch: five were too many.
