...
def build():
    ...
    mats = {
        ...
        "fire": material("WR_MAT_fire", (0.96, 0.18, 0.010, 1), rough=0.18, emission=(1.0, 0.11, 0.003, 1)),
        "fire_core": material("WR_MAT_fire_core", (1.0, 0.50, 0.035, 1), rough=0.16, emission=(1.0, 0.28, 0.010, 1)),
